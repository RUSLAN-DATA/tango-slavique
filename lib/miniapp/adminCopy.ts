...
const en = {
  ...
  applicant: {
    ...
    relationshipExperience: "Relationship experience",
    lookingFor: "Looking for",
    ageRange: "Age",
    heightRange: "Height",
    minimumEducation: "Minimum education",
    importantQualities: "Important qualities",
...
export const adminCopy = {
  ...
  es: {
    ...
    applicant: {
      ...
      about: "Sobre mí",
      partner: "Preferencias de pareja",
      additional: "Información adicional",
      screening: "Filtro inicial",
    photos: "Fotos",
    photoReview: "Revisión de foto con IA",
    ...
    noPhotos: "No hay fotos.",
      ...
      relationshipExperience: "Experiencia de relación",
      lookingFor: "Busca",
      ageRange: "Edad",
      heightRange: "Altura",
      minimumEducation: "Estudios mínimos",
      importantQualities: "Cualidades importantes",
      dealBreakers: "Lo que no acepta",
      intent: "Intención de relación",
      instagram: "Instagram",
      telegram: "Telegram",
      howHeard: "Cómo nos conoció",
      quizGoal: "Objetivo del cuestionario",
      quizGeography: "Geografía",
  ...
  ru: {
    ...
    applicant: {
      ...
      about: "О себе",
      partner: "Предпочтения в партнёре",
      additional: "Дополнительно",
      screening: "Анкета",
    photos: "Фотографии",
    photoReview: "Проверка фото ИИ",
    application: "Заявка",
    source: "Источник",
    status: "Статус",
    createdAt: "Создано",
    ...
    noPhotos: "Фотографий нет.",
      ...
      aboutMe: "О себе",
      hobbies: "Хобби",
      lifeGoals: "Цели жизни",
      relationshipExperience: "Опыт отношений",
      lookingFor: "Кого ищет",
      ageRange: "Возраст",
      heightRange: "Рост",
      minimumEducation: "Минимальное образование",
      importantQualities: "Важные качества",
      dealBreakers: "Что неприемлемо",
      intent: "Намерение в отношениях",
      instagram: "Instagram",
      telegram: "Telegram",
      howHeard: "Откуда узнали о нас",
      quizGoal: "Цель анкеты",
      quizGeography: "География",
      interviewReady: "Готов к интервью",
    },
    photo: {
      face: "Лицо видно",
...
export function statusLabel(t: AdminCopy, status?: string | null) {
  if (!status) return t.applicant.empty;
